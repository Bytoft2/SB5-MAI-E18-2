...
public class Changed extends BasicFormattedTextFieldUI {
    ...
    public View create(Element elem) {
        ...
        return new FieldView(elem) {
            ...
            /**
             * Adjusts the allocation given to the view to be a suitable
             * allocation for a text field. If the view has been allocated more
             * than the preferred span vertically, the allocation is changed to
             * be centered vertically. Horizontally the view is adjusted
             * according to the horizontal alignment property set on the
             * associated JTextField (if that is the type of the hosting
             * component).
             *
             * @param a the allocation given to the view, which may need to be
             * adjusted.
            ...
            protected Shape adjustAllocationXX(Shape a) {
                if (a != null) {
                    ...
                    bounds = verticalAdjustments(bounds, vspan);
